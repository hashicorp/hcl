...
// syntax and HCL JSON.
//
// The hclsimple package includes Decode and DecodeFile, which provide a
// simpler interface for the common case where an application just needs to
// parse and decode a single file into Go struct values.
//
